  ...
  return (
    <header className="sticky top-0 z-50 border-b border-[#0d1b30]/10 bg-[#f6f1e4]/90 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-5 py-3.5 sm:px-6">
        <Link href="/" className="flex min-w-0 flex-1 items-center gap-3 lg:flex-initial">
          ...
          <div className="min-w-0 leading-none">
            ...
            <p className="mt-1 hidden text-[9px] font-extrabold uppercase tracking-[0.24em] text-[#0d1b30]/45 sm:block sm:text-[10px]">
