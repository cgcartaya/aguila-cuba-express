...
import YoyoPromotions from "@/components/landing/yoyo/YoyoPromotions";
...
export default function YoyoLanding() {
  return <main className="min-h-screen bg-[#f6f8fc] text-slate-950"><YoyoNavbar/><YoyoHero/><YoyoPromotions/><UpcomingPickupRoutes storeSlug="yoyo-envios"/><ServicesSection/><QuoteSection/><PickupSection/><FinalSections/><YoyoFooter/></main>;
}
