...
import { CalendarCheck2, Clock, ExternalLink, MapPin, MessageCircle, Phone } from "lucide-react";
...
export default function JotaJotaCTA({ reservasHref = RESERVAS_URL }: { reservasHref?: string }) {
  return (
    <section id="reservas" className="relative overflow-hidden bg-[#0B0A08] py-20 text-white sm:py-28">
      ...
      <div className="relative mx-auto grid max-w-6xl gap-14 px-5 sm:px-8 lg:grid-cols-[1.1fr_0.9fr] lg:gap-10">
        ...
        >
          <p className="text-xs font-bold uppercase tracking-[0.3em] text-[#FEBB1B]">
            Guárdate una mesa junto al horno
          </p>
          <h2
          ...
          <p className="mt-5 max-w-md text-sm leading-7 text-white/55">
            Elige día, hora y mesa en segundos con nuestro sistema de
            reservas, o escríbenos directo por WhatsApp si prefieres
            coordinar todo por mensaje.
          </p>
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="text-sm font-bold uppercase tracking-wide text-white/45">Dirección</p>
              <a
                href={MAPS_URL}
                target="_blank"
                rel="noreferrer"
          ...
          <div className="mt-6 flex items-start gap-4 border-t border-white/10 pt-6">
            ...
            <div>
              <p className="text-sm font-bold uppercase tracking-wide text-white/45">Teléfono</p>
              <p className="mt-1 text-base text-white">{PHONE_DISPLAY}</p>
            </div>
          </div>
          ...
          <div className="mt-6 flex items-start gap-4 border-t border-white/10 pt-6">
            ...
            <div className="w-full">
              <p className="text-sm font-bold uppercase tracking-wide text-white/45">Horario</p>
              <ul className="mt-2 space-y-1.5">
                {HOURS.map((h) => (
                  <li key={h.day} className="flex items-center justify-between text-sm text-white/75">
                    <span>{h.day}</span>
