...
/* =========================================================
   TIENDA PÚBLICA - DETALLE DE COMBO (tiendas con slug)

   Antes solo existía /tienda/combos/[id]. Los banners que
   enlazan a un combo en una tienda con slug propio (distinto
   de "aguila") arman el link como /tienda/{slug}/combos/{id}
   (ver resolveStoreHref en MainBanner.tsx/GeneratedBannerSlide.tsx),
   pero esa ruta no existía → 404 en consola al precargar el link.
   Este archivo es el mismo detalle de combo que /tienda/combos/[id],
   solo que además respeta el slug para el botón de "volver".
========================================================= */
